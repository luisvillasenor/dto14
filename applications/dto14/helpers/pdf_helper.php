...
function prep_pdf($orientation = 'portrait')
{
	...
	if($orientation == 'portrait') {
		...
		$CI->cezpdf->addText(50,32,8,'Impreso el ' . date('m/d/Y h:i:s a'));
		$CI->cezpdf->addText(50,22,8,'Av. Aguascalientes Norte #606 | Fracc. Pulgas Panda | Aguascalientes, Ags. | C.P. 20183 | Tel y Fax: (449) 910 2088 ext. 4300 ');
	}
	else {
