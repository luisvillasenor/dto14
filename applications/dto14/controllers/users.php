...
class Users extends CI_Controller {
	...
	public function agregar(){
		...
		if ($this->form_validation->run() == FALSE ) {
			...
			$this->load->view('http://localhost/gs/gs.php/captura#nvo_user');
...
public function buscar(){
		...
		if ($res !== '') {
			$data['get_one_ciudadano'] = $this->users_model->get_one_ciudadano($res);
			$data['get_all_referencias'] = $this->referencias_model->get_all();
			$data['get_all_secciones'] = $this->secciones_model->get_all_secciones(); 
			$data['get_all_ciudadanos'] = $this->users_model->get_all_ciudadanos();
