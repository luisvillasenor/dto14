        ...
        <div class="span9">
          ...
          <div class="row-fluid" style="text-align:center;">
            <ul class="breadcrumb" style="color: #004036;">
              ...
              <li><a href="../jefes_manzana/index"><strong>Jefes de Manzana</strong></a>  <span class="divider">/</span></li>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>                
                ...
                <?php foreach ($get_one_jm as $one_jm ) : ?>
                  <tr>           
                    <td><?php echo $one_jm->jefe_manzana;?></td>
                    <td><?php echo $one_jm->voto;?></td>
                    <td>
                      <div class="hero-unit">
                        <table>
                          <tr>
                          ...
                          <tr>
                            <td><a href="<?php echo site_url();?>/promotores/index">Promotores</a></td>
                            <td><?php echo $one_jm->estructura;?></td>
                            <td><?php echo $one_jm->votaron;?></td>
                            <td><?php echo $one_jm->calificacion;?></td>
                          </tr>
                        </table>
                      </div>
                      </td>
                      <td>
                        <?php 
                          echo form_open('jefes_manzana/editar_jm'); 
                          echo form_hidden('id_jefe_manzana', $one_jm->id_jefe_manzana);
