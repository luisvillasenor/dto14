...
<head>
	<meta charset="utf-8">
	<title>Responsables de Seccion One</title>   
...
<div class="container-fluid">
    <div id="wrapper" class="row-fluid">        
        <div class="span9">
          ...
          <div class="row-fluid" style="text-align:center;">
            <ul class="breadcrumb" style="color: #004036;">
              ...
              <li><a href="../resp_seccion/index"><strong>Responsables de Sección</strong></a>  <span class="divider">/</span></li>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>                
                ...
                <?php foreach ($get_one_rs as $one_rs ) : ?>
                  <tr>           
                    <td><?php echo $one_rs->resp_seccion;?></td>
                    <td><?php echo $one_rs->voto;?></td>
                    <td>
                      <div class="hero-unit">
                        <table>
                          <tr>
                          ...
                          <tr>
                            <td><a href="<?php echo site_url();?>/jefes_manzana/index">Jefes de Manzana</a></td>
                            <td><?php echo $one_rs->estructura;?></td>
                            <td><?php echo $one_rs->votaron;?></td>
                            <td><?php echo $one_rs->calificacion;?></td>
                          </tr>
                        </table>
                      </div>
                      </td>
                      <td>
                        <?php 
                          echo form_open('resp_seccion/editar_rs'); 
                          echo form_hidden('id_resp_seccion', $one_rs->id_resp_seccion);
        ...
        <?php include 'include/nav_resp_seccion.php';  ?>
    </div><!— /row —>
</div><!— /container —>
