...
<head>
	<meta charset="utf-8">
	<title>Agregar Nuevo Responsable de Seccion View</title>   
...
<div class="container-fluid">
  <div id="wrapper" class="row-fluid">
    <ul class="breadcrumb">
      <li><a href="<?php echo site_url();?>/resp_seccion/index"><i class="icon-home"></i></a> <span class="divider">/</span></li>
      <li><a href="<?php echo site_url();?>/resp_seccion/index">Responsables de Sección</a> <span class="divider">/</span></li>
  ...
  <div class="row-fluid span12">
    ...
    <form>
      <fieldset>
        <legend>Agregar un Nuevo Responsable de Seccion</legend>
        <label>Folio Lista Nominal</label>
          <input type="text" placeholder="Escriba el Folio...">
        <label>Nombre del Responsable de Seccion</label>
