          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>                
                ...
                <?php foreach ($get_calif as $calif_rz ) : ?>
                  <tr>           
                    <td><?php echo $calif_rz->coordinador;?></td>
                    
                    <td style="text-align:center"><?php 
                      switch ($calif_rz->voto) {
                        case '0':
                    ...
                    <td>
                      <div class="hero-unit">
                        <table>
                          ...
                          <tr>                            
                            <td><?php echo $calif_rz->estructura;?></td>
                            <td><?php echo $calif_rz->votaron;?></td>
                            <td><?php echo $calif_rz->calificacion;?></td>
                          </tr>
                        </table>
                      </div>
                      </td>
                      <?php 
                        ...
                        $dataSet->addPoint(new Point("Si", $calif_rz->estructura));
                        $dataSet->addPoint(new Point("No", $calif_rz->votaron));
                        $chart->setDataSet($dataSet);
                        $chart->setTitle("Distrito XIV");
                        $chart->render("posada/resp_zona.png");
                      ?>                      
                  </tr>                  
                <?php endforeach; ?>
