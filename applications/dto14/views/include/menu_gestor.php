<div class="navbar">  
  <div class="navbar-inner">     
      <ul class="nav pull-left">  
        <li>
          <a href="<?php echo site_url();?>/captura/index"><i class="icon-home"></i></a>
        </li>
        <li class="dropdown">          
        ...
        <li class="dropdown">          
          <a class="dropdown-toggle" data-toggle="dropdown" ><strong>Reportes</strong>
            <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
            <!-- dropdown menu links -->                                  
            <li><a data-toggle="modal" href="<?php echo site_url();?>/solicitud/zona_graficas">Zona de Gráficas &raquo;</a></li>
            <li><a data-toggle="modal" href="<?php echo site_url();?>/solicitud/zona_historicos">Zona de Históricos &raquo;</a></li>
            
          </ul>     
        </li>
        <li class="dropdown">          
          <a class="dropdown-toggle" data-toggle="dropdown" ><strong>Monitoreo</strong>
            <span class="caret"></span>
          </a>
          <ul class="dropdown-menu">
            <!-- dropdown menu links -->                                  
            <li><a data-toggle="modal" href="<?php echo site_url();?>/solicitud/zona_monitoreo">Ver Monitoreo &raquo;</a></li>
          </ul>     
        </li>
      </ul> 
...
<div id="nvo_ciud" class="modal hide fade in" style="display: none; ">  
  ...
  <div class="modal-body">  
    <?php echo form_open(site_url().'/ciudadano/agregar'); ?>
    <p>
    <div class="row-fluid">
        <div class="span6">
          <div class="alert">                
