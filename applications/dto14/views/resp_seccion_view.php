...
<head>
	<meta charset="utf-8">
	<title>Responsables de Seccion</title>   
    ...
    <div id="wrapper" class="row-fluid">        
        <div class="span9">
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>                
                <th>Responsables de Sección</th>
                <th>Voto</th>
                <th>Tabla Resumen Activismo</th>
                
              </tr>                    
                <?php foreach ($get_calif as $calif_rs ) : ?>
                  <tr>           
                    <td><?php echo $calif_rs->resp_seccion;?></td>
                    
                    <td style="text-align:center"><?php 
                      switch ($calif_rs->voto) {
                        case '0':
                      ...
                      <div class="hero-unit">
                        <table>
                          ...
                          <tr>
                            ...
                            <td><?php echo $calif_rs->estructura;?></td>
                            <td><?php echo $calif_rs->votaron;?></td>
                            <td><?php echo $calif_rs->calificacion;?></td>
                          </tr>
                        </table>
                      </div>
                      </td>
