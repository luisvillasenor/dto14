...
<head>
	<meta charset="utf-8">
	<title>Editar Coordinador View</title>   
...
<div class="container-fluid">
  <div id="wrapper" class="row-fluid">
    <ul class="breadcrumb">
      <li><a href="<?php echo site_url();?>/coordinadores/index"><i class="icon-home"></i></a> <span class="divider">/</span></li>
      <li><a href="<?php echo site_url();?>/coordinadores/index">Coordinadores</a> <span class="divider">/</span></li>
      <li class="active">Actualizar Coordinador</li>
    </ul>
  </div><!— /row —>
  ...
  <div class="row-fluid span12">
    <!--Body content-->          
    <?php echo form_open('coordinadores/actualizar_co'); ?>
      <fieldset>
        <legend>Actualizar Coordinador ID: <?php echo $value->id_coord; ?></legend>
          <input type="hidden" name="id_coord" value="<?php echo $value->id_coord;?>">
        <label>Folio Lista Nominal</label>
          <input type="text" name="folio" value="<?php echo $value->folio;?>">
        <label>Nombre del Coordinador</label>
          <input type="text" name="coordinador" value="<?php echo $value->coordinador;?>">
        <label>Sección</label>
