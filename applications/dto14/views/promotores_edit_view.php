<?php include "libchart/libchart/classes/libchart.php";
  $chart = new PieChart(200,180);
  $dataSet = new XYDataSet();
  $dataSet->addPoint(new Point("Si", 66.67));
  $dataSet->addPoint(new Point("No", 33.34));
  $chart->setDataSet($dataSet);
  $chart->setTitle("Distrito XIV");
  $chart->render("posada/promotores.png");
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="span9">
          ...
          <div class="row-fluid" style="text-align:center;">
            <ul class="breadcrumb" style="color: #004036;">
              <li><h2><a href="<?php echo site_url();?>/promotores/index">Promotores</a></h2></li>
            </ul>            
          </div>                      
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>                
                ...
                <?php foreach ($get_pr as $datos_pm ) : ?>
                  <tr>           
                    <td><a href="#"><?php echo $datos_pm->promotor;?></a></td>
                    <td><?php echo $datos_pm->voto;?></td>
                    <td>
                      <div class="hero-unit">
                        <table>
                          <tr>                                                        
                          ...
                          <tr>                                                        
                            <td><?php echo $datos_pm->promovidos;?></td>
                            <td><?php echo $datos_pm->real;?></td>
                            <td><?php if ($datos_pm->promovidos != 0) {
                              echo (($datos_pm->real/$datos_pm->promovidos)*100); } ?></td>
                          </tr>
                        </table>
                      </div>
                      </td>
                      <td><img src="<?php echo base_url(); ?>posada/promotores.png" class="img-rounded border-radius" ></td>                      
                  </tr>                  
                <?php endforeach; ?>
            </tbody>
          </table>
