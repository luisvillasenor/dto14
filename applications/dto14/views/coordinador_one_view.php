...
<head>
	<meta charset="utf-8">
	<title>Coordinadores One View</title>   
...
<div class="container-fluid">
    ...
    <div id="wrapper" class="row-fluid">
        ...
        <div class="span9">
          ...
          <div class="row-fluid" style="text-align:center;">
            <ul class="breadcrumb" style="color: #004036;">
              ...
              <li><a href="../coordinadores/index"><strong>Coordinadores</strong></a>  <span class="divider">/</span></li>
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>                
                ...
                <?php foreach ($get_one_co as $one_co ) : ?>
                  <tr>           
                    <td><?php echo $one_co->coordinador;?></td>
                    <td><?php echo $one_co->voto;?></td>
                    <td>
                      <div class="hero-unit">
                        <table>
                          <tr>
                          ...
                          <tr>
                            <td><a href="<?php echo site_url();?>/resp_zona/index">Responsables de Zona</a></td>
                            <td><?php echo $one_co->estructura;?></td>
                            <td><?php echo $one_co->votaron;?></td>
                            <td><?php echo $one_co->calificacion;?></td>
                          </tr>
                        </table>
                      </div>
                      </td>              
                      <td>
                        <?php 
                          echo form_open('coordinadores/editar_co'); 
                          echo form_hidden('id_coord', $one_co->id_coord);
        ...
        <?php include 'include/nav_coord.php';  ?>
