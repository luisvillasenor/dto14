...
<head>
	<meta charset="utf-8">
	<title>Ver Retroalimentacion</title>
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
              ...
              <tbody>  
                ...
                <tr>
                  <td colspan="2">
                    ...
                    Col ó Fracc.: <?php echo $item->ref_id ;?> / 
                    C.P.: <?php echo $item->cp;?>
                  </td>
                </tr>
                ...
                <tr>
                  <td colspan="2">
                    ...
                    Hora aprox. para localizar: <?php echo $item->hora ;?>
                  </td>
                </tr>
                <?php } ?> <!— FIN DEL FOREND —>
              </tbody>
        ...
        <div class="span6">
          ...
          <div class="alert alert-success">
              <div class="alert">                
                <h2><medium>Módulo de Retroalimentación</medium></h2>
              </div>
            <table class="table table-bordered">          
              <thead>
                <tr>              
            ...
            $tipo_id = array('Gestión de Agua','Gestión de Predial','Gestión de Luz','Gestión de Gas LP','Gestión de Medicamentos y Consultas','Gestión de Servicios Públicos Generales','Gestión de Seguridad Pública y Tránsito','Gestión de Asesoría Jurídica');
                  ...
                  <td>
                    <div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                              <!-- dropdown menu links -->                                  
                              <li class="dropdown"><a data-toggle="modal" href="#agre_retro_soli_<?php echo $value->solicitud_id;?>">Agregar Retro &raquo;</a></li>
                            </ul> 
                      </div>
                  </td>
                </tr>
                ...
                <!— /Ventana Modal AGREGAR RETROALIMENTACION —>
                      <div id="agre_retro_soli_<?php echo $value->solicitud_id;?>" class="modal hide fade in" style="display: none; ">  
                        <div class="modal-header">  
                          <a class="close" data-dismiss="modal">X</a>  
                          <h3>Datos de la Solicitud No: <?php echo $value->solicitud_id;?> </h3>  
                        </div>  
                        <div class="modal-body">
                          <?php echo form_open(site_url().'/retro/agregar'); ?>
    
                              <input type="hidden" name="solicitud_id" id="solicitud_id" value="<?php echo $value->solicitud_id;?>">
                              <input type="hidden" name="gestor" id="gestor" value="<?php echo $_SESSION['username'];?>">
          ...
          <div class="alert alert-success">
            <table class="table table-bordered">          
              ...
              <tbody>
                <?php 
                foreach ($get_all_retro as $segui) { ?>
                  <tr>
                    <td><?php echo $segui->retro_id;?></td>
