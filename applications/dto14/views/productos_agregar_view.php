...
<head>
	<meta charset="utf-8">
	<title>Agregar Nuevo Producto View</title>   
...
<div class="container-fluid">
    ...
    <div class="row-fluid">
        ...
        <div class="alert alert-success span8">
          ...
          <form>
            <fieldset>
              <legend>Agrenar un Nuevo Producto hidroClean</legend>
              <label>Nombre del Producto</label>
              <input type="text" placeholder="Escriba el nombre…">
              <span class="help-block">Escribir en MAYUSCULAS.</span>
              <label class="checkbox">
                <input type="checkbox"> Activar Producto
              </label>
